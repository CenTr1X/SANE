...
#define configTOTAL_HEAP_SIZE             ( ( size_t ) ( 1024 * 1024 * 64) )
...
//
// the following line is not needed, no one is use this macro
//
...
//just for cortex-a9 test!
/*
#define configUSE_TASK_FPU_SUPPORT 2
#define configUNIQUE_INTERRUPT_PRIORITIES 32
#define configMAX_API_CALL_INTERRUPT_PRIORITY 18
#define configINTERRUPT_CONTROLLER_BASE_ADDRESS 		( 0x10140000U )
